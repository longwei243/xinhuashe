...
public class NewsTitleTabTextView extends TextView {
	...
	public NewsTitleTabTextView(Context context) {
		super(context);
		init(context);
	}

	public NewsTitleTabTextView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public NewsTitleTabTextView(Context context, AttributeSet attrs, int defStyle) {
