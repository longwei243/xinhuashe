...
public class SecondListViewAdapter extends BaseAdapter{
	...
	public SecondListViewAdapter(Context context, FragmentManager manager, List<Category> categories, List<Article> articles) {
		super();
	...
	public View getView(final int position, View arg1, ViewGroup arg2) {
		...
		/*first_news_listview_item_top_layout.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					ParentFragment fragment_china = new SecondNewsItemFragment();
