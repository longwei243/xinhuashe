    ...
    public IQ parseIQ(XmlPullParser parser) throws Exception {
        ...
        for (boolean done = false; !done;) {
            ...
            if (eventType == 2) {
                ...
                }else if("titleId".equals(parser.getName())){
                	notification.setTitleId(parser.nextText());
                }else if("additional".equals(parser.getName())){
                	notification.setAdditional(parser.nextText());
                }
            } else if (eventType == 3
