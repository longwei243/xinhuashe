...
public class Notifier {
	...
	public void notify(String notificationId, String apiKey, String title, String message, String uri, String from, String packetId, String notificationTitleId, String messageType) {
		Log.d(LOGTAG, "notify()...");
		...
		if (isNotificationEnabled()) {
			...
			if(Integer.parseInt(messageType) == 0){
				...
				intent.putExtra(Constants.NOTIFICATION_TITLEID, notificationTitleId);
