	...
	private void createDebug() {
		...
		readerListener = new ReaderListener() {
			public void read(String str) {
				Log.d("SMACK", dateFormatter.format(new Date()) + " RCV  (" + connection.hashCode() + "): " + str);
			}
		};
		...
		writerListener = new WriterListener() {
			public void write(String str) {
				Log.d("SMACK", dateFormatter.format(new Date()) + " SENT (" + connection.hashCode() + "): " + str);
			}
		};
		...
		listener = new PacketListener() {
			public void processPacket(Packet packet) {
				if (printInterpreted) {
					Log.d("SMACK", dateFormatter.format(new Date()) + " RCV PKT (" + connection.hashCode() + "): " + packet.toXML());
				}
			}
		};
